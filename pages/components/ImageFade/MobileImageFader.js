...
import { MOBILE_IMAGES } from './utils';

const MobileImageFader = () => {
  const [state, dispatch] = useReducer(visibleImagesReducer, getDefaultState(MOBILE_IMAGES));
...
export default MobileImageFader;
